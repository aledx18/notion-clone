  ...
  return (
    <>
      <section className='flex flex-col gap-4 justify-center items-start md:items-center'>
        <article className='rounded-full p-[1px] text-sm bg-gradient-to-r from-primary-foreground to-primary'>
          <div className='rounded-full px-3 py-1 bg-black'>{pill}</div>
        </article>
        {subheading ? (
          <>
            ...
            <p className='text-purple-700 sm:max-w-[450px] md:text-center'>
              {subheading}
            </p>
          </>
        ) : (
